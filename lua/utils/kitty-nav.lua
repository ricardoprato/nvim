...
function M.navigate(dir)
	...
	-- Floating windows (claudecode, lazygit, lazydocker, etc.) act as the
	-- only "pane" for navigation purposes: skip wincmd and jump straight to
	-- a kitty pane. The float stays open; returning to nvim later restores
	-- focus to it.
